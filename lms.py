...
driver.find_element_by_xpath('//*[@id="homebody"]/div[2]/div/button[2]').click()
...
driver.find_element_by_xpath('/html/body/app-root/app-layout-full/div[1]/main/div/app-login/div/div/div/div/div[2]/div/div[1]/form/div[4]/div/button').click()
